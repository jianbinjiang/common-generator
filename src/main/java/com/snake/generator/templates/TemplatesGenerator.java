package com.snake.generator.templates;
...
/**
 * @author jjbin
 * @version 创建时间：2019年4月15日 上午11:26:34 
 * 类说明: mybatis-plus 使用自定义模板代码生成器
 */
public class TemplatesGenerator {

  //前端首页生成地址
  private static final String DISK_HTML = "F://test//html//";
  //后端控制器以及服务生成地址
  private static final String DISK_JAVA = "F://test//";
  private static final String AUTHOR = "snake";
  ...
  public static void main(String[] args) {
    ...
    dsc.setUrl("jdbc:mysql://127.0.0.1:3306/sanke?characterEncoding=utf8");
    ...
    pc.setParent("com.saas.ams.module.logs");
